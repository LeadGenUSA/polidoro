...
const SmartInput = ({ value, onChange, id, placeholder, className }: SmartInputProps) => {
      ...
      <div className="relative">
        ...
        {!isFixing && value.trim() && (
          <button
            ...
            className="absolute top-1/2 -translate-y-1/2 right-2 p-1 rounded-md hover:bg-accent text-muted-foreground hover:text-primary transition-colors"
