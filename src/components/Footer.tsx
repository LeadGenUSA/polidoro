        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/reviews" className="text-primary-foreground/80 hover:text-secondary transition-colors text-sm">
                  Reviews
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/contact-us" className="text-primary-foreground/80 hover:text-secondary transition-colors text-sm">
                  Contact
                </Link>
              </li>
              <li>
                <Link to="/financing" className="text-primary-foreground/80 hover:text-secondary transition-colors text-sm">
                  Financing
                </Link>
              </li>
            </ul>
